...
#include "Cipher.h"
// our code 
unsigned long ChannelNumber = 1922372;
unsigned long RPMFieldNumber = 2;
unsigned long VFieldNumber = 1;
const char * myWriteAPIKey = "SNB1WAXEF9EI5O07";

const char* ssid = "Manav";
const char* password = "manavshah24";
...
//      ThingSpeak.setField(VFieldNumber, voltage);
      ...
      Serial.println("Rpm val ");
      Serial.println(RPM);
//       Serial.println("Voltage val ");
...
void getPWM()
{
  if ((millis() - lastGETTime) > GETTimerDelay) {
    ...
    if(WiFi.status()== WL_CONNECTED){
      ...
      String serverPath = "https://api.thingspeak.com/channels/1922372/fields/1.json?api_key=AFJ4TPE2QRRSIKCX&results=2";
...
//        Serial.println(httpResponseCode);
        ...
        String pwmVal = JSON.stringify(obj["feeds"][1]["field1"]);
